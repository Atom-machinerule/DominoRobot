...
class Processing:
    ...
    def get_domino_points(self):
        ...
        cv2.putText(self.image_data, text, (20, 70), cv2.FONT_HERSHEY_SIMPLEX, 1.5,(0,0,255),5)
#cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255,255,255))
    ...
    def change_background_colors(self,image_data):
        ...
        image_palette = palette[image_data]
